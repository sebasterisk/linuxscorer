...
class Module(App):
    ...
    VULNS = [ 
        ...
        Vuln(Answer(CheckType.STRING_NOT_FOUND, checking_for="alias nano=", in_path = Path("/etc/profile.d/20-startup.sh"), path_gone_ok = True), points = 4, desc = "Malicious alias removed"),
